...
class Queue
{
    ...
    /**
     * Método reponsável por contruir a classe de fila de middlewares
    ...
    /**
     * Método responsável por definir mapeamento de middlewares padrões
     * @param array $default
     */
    ...
    public function next($request)
    {
        ...
        if (!isset(self::$map[$middleware])){
            throw new \Exception("Problema ao processaor o Middleware da requisição", 500);
        }
